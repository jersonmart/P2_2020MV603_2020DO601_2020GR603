...
namespace P2_2020MV603_2020DO601_2020GR603.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public GeneroesController(casosDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genero != null ? 
                          ...
                          Problem("Entity set 'casosDbContext.Genero'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("id_Genero,Tipo_Genero")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_Genero,Tipo_Genero")] Genero genero)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'casosDbContext.Genero'  is null.");
            }
            var genero = await _context.Genero.FindAsync(id);
            if (genero != null)
            {
