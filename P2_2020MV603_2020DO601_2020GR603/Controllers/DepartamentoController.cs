...
namespace P2_2020MV603_2020DO601_2020GR603.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public DepartamentoController(casosDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamento != null ?
                          ...
                          Problem("Entity set 'casosDbContext.Departamento'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'casosDbContext.Departamento'  is null.");
            }
            var departamento = await _context.Departamento.FindAsync(id);
            if (departamento != null)
            {
